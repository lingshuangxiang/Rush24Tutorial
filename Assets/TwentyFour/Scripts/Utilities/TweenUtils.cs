...
namespace TwentyFour.Scripts.Utilities
{
    public class TweenUtils
    {
        ...
        public static Sequence DOPressSequence(Transform transform, float duration = AnimationDurationShort,
            Sequence sequence = null, float softness = .2f)
        {
            ...
            sequence.Append(transform.DOScale(
                new Vector3((1f + 0.2f * softness) * scaleX, (1 - 0.2f * softness) * scaleY, transform.localScale.z),
                1f / 4f * AnimationDurationShort));
            sequence.Append(transform.DOScale(
                new Vector3((1 - 0.2f * softness) * scaleX, (1f + 0.2f * softness) * scaleY, transform.localScale.z),
                1f / 4f * AnimationDurationShort));
            sequence.Append(transform.DOScale(new Vector3(scaleX, scaleY, transform.localScale.z),
                1f / 2f * AnimationDurationShort));
